...
public class CoastalClustersWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CoastalClustersWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CoastalClustersWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CoastalClustersWLAIW/InitOutcome.xml").getDocumentElement();
